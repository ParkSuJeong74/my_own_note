...
import { WorkspaceNotFoundError, type AccessIdentity, type IdentityRepository, type WorkspaceRepository } from "../src/types";
...
function handler(options: { authError?: boolean; storageError?: boolean; workspaceMissing?: boolean } = {}) {
