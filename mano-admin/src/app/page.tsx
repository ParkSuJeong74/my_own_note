...
export default async function OverviewPage() {
  ...
  return <>
    ...
    <section className="metrics">
      ...
      <article className="metric health-total"><span>Service health</span><strong>{counts.healthy}/{data.services.length}</strong><p>{counts.unhealthy} down · {counts.unknown} unknown</p></article>
    </section>
