...
import { listUpcoming, listWorkspaceBoardSummary } from "@/lib/automation-repository";

export const dynamic = "force-dynamic";

export default async function OverviewPage() {
  const [data, board, upcoming] = await Promise.all([getDashboardData(), listWorkspaceBoardSummary(), listUpcoming()]);
