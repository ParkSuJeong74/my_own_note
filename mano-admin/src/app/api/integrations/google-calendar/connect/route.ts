...
import { googleCalendarAuthorizationUrl, googleCalendarRedirectUri } from "@/lib/google-calendar";
...
export async function GET(request: Request) {
  ...
  const state = randomBytes(24).toString("base64url"), redirectUri = googleCalendarRedirectUri();
