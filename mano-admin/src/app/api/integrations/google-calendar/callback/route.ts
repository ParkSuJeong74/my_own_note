...
import { connectGoogleCalendar, googleCalendarRedirectUri, pullGoogleCalendarChanges, retryGoogleCalendarSync } from "@/lib/google-calendar";
...
export async function GET(request: Request) {
  ...
  try { await connectGoogleCalendar(code, googleCalendarRedirectUri()); await retryGoogleCalendarSync(); await pullGoogleCalendarChanges(true); target.searchParams.set("google", "connected"); }
