...
export async function POST(request:Request){
  ...
  const values={measuredOn:body.measuredOn,visitors:optionalGrowthMetric(body.visitors),views:optionalGrowthMetric(body.views),posts:optionalGrowthMetric(body.posts)};
