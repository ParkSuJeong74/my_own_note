...
const exactRoutes = new Set(["/api/t1/sync", "/api/t1/monitor", "/api/t1/live-monitor", "/api/integrations/blog/replies", "/api/integrations/blog/neighbors", "/api/integrations/blog/growth"]);
