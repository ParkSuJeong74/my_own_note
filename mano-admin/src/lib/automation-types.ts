...
export type WorkspaceEditableDetails = { summary?:string; purpose?:string; direction?:string; responsibilities?:string[]; workflow?:string[]; taskGuidance?:string };
...
export type HealthMeasurement = { id:string; measuredOn:string; weightKg:number; bodyFatPct:number|null; skeletalMuscleKg:number|null; note:string; updatedAt:string };
