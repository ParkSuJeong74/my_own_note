...
export type HealthMeasurement = { id:string; measuredOn:string; weightKg:number; bodyFatPct:number|null; skeletalMuscleKg:number|null; waistCm:number|null; note:string; updatedAt:string };
