...
const personalLinks = [{href:"/pages",label:"Pages"},{href:"/calendar",label:"Calendar"},{href:"/health",label:"Health"},{href:"/money",label:"Money"},{href:"/t1",label:"T1 WIN"},{href:"/notifications",label:"Notifications"}];
